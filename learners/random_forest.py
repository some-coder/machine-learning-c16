...
class RandomForest(Learner):
	"""
	The random forest learning algorithm. Given data, this class
	constructs and stores multiple, differently initialised decision
	trees that can be used to classify test data-points in an
	ensemble set-up.
	"""
